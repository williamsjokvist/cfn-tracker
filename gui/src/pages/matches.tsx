  ...
  return (
    <Page.Root>
      ...
      <div className='relative w-full'>
        <div className='mb-2 flex h-10 items-center justify-between border-b border-slate-50/10 px-8 pt-1'>
          <Button
            ...
            <tbody>
              {matches.map(log => (
                <Table.Tr key={`${log.date}${log.time}`}>
                  ...
                  >
                    <Tooltip text={t('copy')}>
                      <span className='block w-12 overflow-hidden text-ellipsis'>
                        {log.replayId}
                      </span>
                    </Tooltip>
                  </Table.Td>
